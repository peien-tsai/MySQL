CREATE TABLE emp1(
-- column level constraint(限制寫在欄位的後面)
...
-- table level constraint(限制寫在表格的最後面(所有欄位的後面))
...
-- Error Code: 1062. Duplicate entry 'lee@gmail.com' for key 'email' (重複輸入Unique欄位的email)
INSERT INTO emp1
...
-- altertable→點FK→改成casecard(一併跟著刪除或更新)
